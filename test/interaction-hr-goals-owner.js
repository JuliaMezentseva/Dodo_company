...
(async () => {
  try {
    ...
    console.log("After clicking checkpoints tab — checkpoints content visible (empty state):", body.includes("Отслеживайте прогресс адаптации на регулярных встречах") ? "PASS" : "FAIL");
