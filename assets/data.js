    ...
    checkpoints: {
      acp1: {
        ...
        survey: [
          ...
          { q: "Какие сложности у вас сейчас возникают и какая поддержка вам необходима?", type: "text",
            answer: "Пока сложно самостоятельно разобраться в архитектуре репозитория, часто нужна помощь тимлида." },
        ],
        surveySubmitted: true,
        employeeSummary: "Обсудили сложности с архитектурой репозитория — договорились о дополнительных встречах с тимлидом и более плотном код-ревью ближайший месяц.",
        internalReport: "Сотрудник пока неуверенно ориентируется в архитектуре, самостоятельные задачи даются тяжело. Нужен усиленный контроль и поддержка в ближайший месяц.",
        riskLevel: "high",
        comments: [],
      ...
      acp2: {
        ...
        survey: [
          ...
          { q: "Какие сложности у вас сейчас возникают и какая поддержка вам необходима?", type: "text",
            answer: "Разобрался с окружением и репозиторием, сейчас сложнее даётся код-ревью — иногда не понимаю замечания тимлида с первого раза." },
        ],
        surveySubmitted: true,
        employeeSummary: "", internalReport: "", riskLevel: "", comments: [], employeeComment: "",
      },
      acp3: {
        ...
        survey: [
          ...
          { q: "Насколько уверенно вы справляетесь с рабочими задачами на текущем этапе?", type: "scale", answer: 4, minLabel: "Совсем не уверенно", maxLabel: "Полностью уверенно" },
          { q: "Какие сложности у вас сейчас возникают и какая поддержка вам необходима?", type: "text",
            answer: "Уверенно беру задачи в работу, иногда нужна помощь с оценкой сроков на новых для меня модулях." },
        ],
        surveySubmitted: true,
